  ...
  <tbody>	
	...
	<tr>
		<td style="background-color: #FEF8F4;" bgcolor="#FEF8F4"><table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" align="center">
			<tr>
				<td style="font-family: Arial, Helvetica, sans-serif; font-size: 24px; font-weight: bold; line-height: 30px; color: #000000; padding:8px 15px">Forgot password</td>	
				<td width="52" style="text-align: right; padding-right: 30px;"><img src="{{ url('/')}}/public/notifications/images/password-changed.png" width="36" height="35" alt=""></td>			
			</tr>
	...
	<tr>
		<td bgcolor="#ffffff" style="background: #ffffff; padding:20px 15px;"><table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" align="center">
			...
			<tr>
				<td style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; color: #383838; line-height: 24px; padding-bottom:25px">Did you forget your password?</td>
			</tr>
			<tr>
				<td style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; color: #383838; line-height: 24px; padding-bottom:25px">No problem! Please click the link below to reset your password.</td>
			</tr>
					
			<tr>
				<td style="padding-bottom: 20px;"><table width="210" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
					<tbody>
					  <tr>
						<td height="40" valign="middle" bgcolor="#00A651" style="background:#00A651; font-family:Arial, Helvetica, sans-serif; font-size:18px; text-align:center; font-weight:bold;"><a class="btn-color" href="{{ $data['link']}}" style="color:#ffffff; text-decoration:none; display:block; width:100%; line-height:30px;">Reset Your Password</a></td>                  
					  </tr> 
			...
			<tr>
				<td style="padding-top:20px;"><table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" align="center" class="mob-hidden">
					<tr>
						...
						<td style="padding:0 8px;"><img src="{{ url('/')}}/public/notifications/images/dot.png" height="3" width="3" alt=""></td>
						<td style="font-family: Arial, Helvetica, sans-serif; font-size: 18px;"><a href="{{ url('/')}}" style="color: #F7941D; text-decoration: none;;"><span style="color:#f7941d; text-decoration:none;">Contact Us</span></a></td>	
