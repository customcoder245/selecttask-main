...
<body text="#706c72" link="#706c72" vlink="#706c72" alink="#706c72" marginheight="0" marginwidth="0" bgcolor="#F7F7F7" style="background-color:#F7F7F7; color:#000000;"><table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="#F7F7F7" style="background-color:#F7F7F7; color:#000000; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" align="center">
  ...
  <tbody>	
	...
	<tr>
		<td style="background-color: #F7361D;" bgcolor="#F7361D"><table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" align="center">
			<tr>
				<td style="font-family: Arial, Helvetica, sans-serif; font-size: 24px; font-weight: bold; line-height: 30px; color: #ffffff; padding:8px 15px">Security alert: Select Task account inquiry</td>	
				<td width="50" style="text-align: center;"><img src="{{ url('/')}}/public/notifications/images/alert-wt.png" width="35" height="35" alt=""></td>			
			</tr>
	...
	<tr>
		<td bgcolor="#ffffff" style="background: #ffffff; padding:20px 15px;"><table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" align="center">
			<tr>
				<td style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; font-weight: bold; color: #00A651; line-height: 24px; padding-bottom:25px">Hey {{ $data['name'] }},</td>				
			</tr>
			<tr>
				<td style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; color: #383838; line-height: 24px; padding-bottom:25px">Your account has been accessed from a different location. You’re getting this email to make sure it was you. If it 
					wasn’t, we recommend that you update your password.</td>
			</tr>
			<tr>
				<td style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; color: #383838; line-height: 24px; padding-bottom:20px;">Below is the information of the new location:</td>
			</tr>
			<tr>
				<td style="padding: 10px 0; border-top: 1px #E6E6E6 solid; border-bottom: 1px #E6E6E6 solid;"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
					<tbody>
					  <tr>
						<td width="26%" style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#838383; line-height: 24px;">City</td>
						<td width="26%" style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#838383; line-height: 24px;">State</td>
						<td width="26%" style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#838383; line-height: 24px;">Country</td>
						<td width="22%" style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#838383; line-height: 24px;">Continent</td>                  
					  </tr> 
					  <tr>
						<td style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#000000; font-weight: bold; line-height: 24px;">{{ $data['city']}}</td>
						<td style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#000000; font-weight: bold; line-height: 24px;">{{ $data['state']}}</td>
						<td style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#000000; font-weight: bold; line-height: 24px;">{{ $data['country']}}</td>
						<td style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color:#000000; font-weight: bold; line-height: 24px;">{{ $data['zone']}}</td>                  
					  </tr>
			...
			<tr>
				<td style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; color: #383838; line-height: 24px; padding-top:20px;">Regards,<br />The Select Task Support Team</td>
			</tr>
	...
	<tr>
		<td style="padding:20px 0;"><table width="230" align="center" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="contenttable">
			<tbody>
			  <tr>
				<td height="40" valign="middle" bgcolor="#F7941D" style="background:#F7941D; font-family:Arial, Helvetica, sans-serif; font-size:18px; text-align:center; font-weight:bold;"><a class="btn-color" href="#" style="color:#ffffff; text-decoration:none; display:block; width:100%; line-height:40px;">Sign in to your account</a></td>                  
			  </tr> 
