...
<body>
    <div class="wrapper">
        ...
        <figure class="banner banner-inner banner-hvacTech">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-12">
                        <div class="bannerContent">
                            <span class="jobDetailsTitle">Job Details</span>
                            <h2>HVAC Contractor Jobs <span class="mobBlock">in New York City</span></h2>
                   ...
                   <div class="jobDetailsLeft">
                       ...
                       <div class="detailsRow">
                            ...
                            <div class="detailsRowContent">
                                <p>HVAC technicians in New York City typically charge between <strong>$75-$150</strong> per hour depending on their location and level of experience, with an average minimum service call price of <strong>$150.</strong></p>
                            </div>                        
                        </div><!--//Salary-->
                        ...
                        <div class="detailsRow">
                            ...
                            <div class="detailsRowContent">
                                ...
                                <ul class="bulletedlist">
                                    <li>Experience with furnace and AC maintenance and repairs</li>
                                    <li>Relevant certifications and previous job experience</li>
                                    <li>NYC-issued licences required for techs who work on high-pressure boilers and oil furnaces, if applicable</li>
                                </ul>
                            </div> 
                            <div class="detailsRowContent">
                                <h4>Job Requirements:</h4>
                                <ul class="bulletedlist">
                                    <li>Projects may include AC unit or parts replacements or repairs, furnace parts replacements or repairs, or fixing faulty ductwork</li>
                                </ul>
                            </div>   
                            <div class="detailsRowContent">
                                <h4>Benefits:</h4>
                        ...
                        <div class="services-widget" id="sidescroller">
                            <div class="borderedframe">
                                ...
                                <div class="serviceText">
                                    <h5>HVAC Contractor Jobs</h5>
                                    <a href="{{ route('sign-up')}}?cat=1" class="btn btn-green btn-green-shadow w-100 applyNow">Apply Now</a>
                                </div>
                            </div>
                        </div>
                   </div><!--//Right-->
