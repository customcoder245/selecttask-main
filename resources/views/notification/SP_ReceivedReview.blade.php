  ...
  <tbody>	
	...
	<tr>
		<td style="background-color: #FEF8F4;" bgcolor="#FEF8F4"><table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" align="center">
			<tr>
				<td style="font-family: Arial, Helvetica, sans-serif; font-size: 24px; font-weight: bold; line-height: 30px; color: #000000; padding:8px 15px;">Read your Select Task customer’s review</td>	
				<td width="50" style="text-align: center;"><img src="images/review.png" width="35" height="36" alt=""></td>			
			</tr>
	...
	<tr>
		<td bgcolor="#ffffff" style="background: #ffffff; padding:20px 15px;"><table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" align="center">			
			<tr>
				<td style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; color: #383838; line-height: 24px; padding-bottom:25px">Congrats, one of your Select Task customers left you a review! To see what they wrote, visit your profile. Now it’s
					time to start looking for your next project! </td>
			</tr>
			<tr>
				<td><table width="140" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
					<tbody>
					  <tr>
						<td height="40" valign="middle" bgcolor="#00A651" style="background:#00A651; font-family:Arial, Helvetica, sans-serif; font-size:18px; text-align:center; font-weight:bold;"><a class="btn-color" href="{{ route('provider-ratings-reviews')}}" style="color:#ffffff; text-decoration:none; display:block; width:100%; line-height:40px;">View Review</a></td>                  
					  </tr> 
	...
	<tr>
		<td style="padding:20px 0;"><table width="230" align="center" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="contenttable">
			<tbody>
			  <tr>
				<td height="40" valign="middle" bgcolor="#F7941D" style="background:#F7941D; font-family:Arial, Helvetica, sans-serif; font-size:18px; text-align:center; font-weight:bold;"><a class="btn-color" href="{{ route('provider-search-task')}}" style="color:#ffffff; text-decoration:none; display:block; width:100%; line-height:40px;">Search Tasks </a></td>                  
			  </tr> 
