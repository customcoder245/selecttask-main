...
<body>
    <div class="wrapper">
        ...
        <figure class="banner banner-inner banner-plumbing">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-12">
                        <div class="bannerContent">
                            <span class="jobDetailsTitle">Job Details</span>
                            <h2>Plumbing Jobs <span class="mobBlock">in New York City</span></h2>
                   ...
                   <div class="jobDetailsLeft">
                       ...
                       <div class="detailsRow">
                            ...
                            <div class="detailsRowContent">
                                <p>The average hourly rate for a plumber in New York City is <strong>$100-200,</strong> but this depends on the task requested.</p>
                            </div>                        
                        </div><!--//Salary-->
                        ...
                        <div class="detailsRow">
                            ...
                            <div class="detailsRowContent">
                                ...
                                <ul class="bulletedlist">
                                    <li>Experience ranging from appliance repairs, fixing leaks, unclogging drains, repiping buildings, fixing water heaters, and more</li>
                                    <li>Relevant certifications and previous job experience</li>
                                    <li>Valid state-mandated license and minimum insurance policy requirements</li>
                                </ul>
                            </div> 
                            <div class="detailsRowContent">
                                <h4>Job Requirements:</h4>
                                <ul class="bulletedlist">
                                    <li>Projects may include minor repairs like leaky showers and sinks, major repairs like repiping a building, repairing damage caused by burst pipes, and appliance repairs</li>
                                </ul>
                            </div>   
                            <div class="detailsRowContent">
                                <h4>Benefits:</h4>
                        ...
                        <div class="services-widget" id="sidescroller">
                            <div class="borderedframe">
                                ...
                                <div class="serviceText">
                                    <h5>Plumbing Jobs</h5>
                                    <a href="{{ route('sign-up')}}?cat=5" class="btn btn-green btn-green-shadow w-100 applyNow">Apply Now</a>
                                </div>
                            </div>
                        </div>
                   </div><!--//Right-->
