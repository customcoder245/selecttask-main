  ...
  <tbody>	
	...
	<tr>
		<td style="background-color: #FEF8F4;" bgcolor="#FEF8F4"><table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" align="center">
			<tr>
				<td style="font-family: Arial, Helvetica, sans-serif; font-size: 24px; font-weight: bold; line-height: 30px; color: #000000; padding:8px 15px;">Time to leave a review for your Select Task pro!</td>	
				<td width="50" style="text-align: center;"><img src="{{ url('/')}}/public/notifications/images/review.png" width="35" height="35" alt=""></td>			
			</tr>
						
		</table></td>
	  </tr>
	<tr>
		<td bgcolor="#ffffff" style="background: #ffffff; "><table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" align="center">			
			<tr>
				<td style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; color: #383838; line-height: 24px; padding:20px 15px 25px;">Now that you marked your Task as complete, it’s time to leave a review for your pro.</td>
			</tr>
			<tr>
				<td style="padding-top: 40px;"><table align="center" width="349" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="contenttable">
					<tbody>
					  <tr>
						<td style="text-align: center;"><table align="center" width="100%" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
							<tbody>
							  <tr>
								<td><img src="{{ url('/')}}/public/notifications/images/star.png" width="39" height="36" alt=""></td>                  
							  </tr> 
							  <tr>
								<td style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: #838383; line-height: 22px; padding-top:5px;">Terrible</td>                  
							  </tr> 							  
							</tbody>
						  </table></td>  
						<td style="text-align: center;"><table align="center" width="100%" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
							<tbody>
							  ...
							  <tr>
								<td style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: #838383; line-height: 22px; padding-top:5px;">Poor</td>                  
							  </tr> 							  
							</tbody>
						  </table></td>
						  <td style="text-align: center;"><table align="center" width="100%" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
							<tbody>
							  ...
							  <tr>
								<td style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: #838383; line-height: 22px; padding-top:5px;">Average</td>                  
							  </tr> 							  
							</tbody>
						  </table></td>    
						  <td style="text-align: center;"><table align="center" width="100%" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
							<tbody>
							  ...
							  <tr>
								<td style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: #838383; line-height: 22px; padding-top:5px;">Good</td>                  
							  </tr> 							  
							</tbody>
						  </table></td>           
						  <td style="text-align: center;"><table align="center" width="100%" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
							<tbody>
							  ...
							  <tr>
								<td style="font-family: Arial, Helvetica, sans-serif; font-size: 14px; color: #838383; line-height: 22px; padding-top:5px;">Excellent</td>                  
							  </tr> 							  
							</tbody>
						  </table></td>   
					  </tr> 
			...
			<tr>
				<td style="padding-bottom: 15px;"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
					<tbody>
					  <tr>
						<td width="70"><img src="{{ url('/')}}/public/notifications/images/l-hand.png" width="70" height="58" alt=""></td>  
						  <td style="padding-top:35px;"><table align="center" width="150" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
							<tbody>
							  <tr>
								<td height="40" valign="middle" bgcolor="#F7941D" style="background:#F7941D; font-family:Arial, Helvetica, sans-serif; font-size:18px; text-align:center; font-weight:bold;"><a class="btn-color" href="{{ route('status-open',['id'=>$data['task_id']])}}" style="color:#ffffff; text-decoration:none; display:block; width:100%; line-height:40px;">Leave Review</a></td>                  
							  </tr> 
							  
							</tbody>
						  </table></td> 
						  <td width="70"><img src="{{ url('/')}}/public/notifications/images/r-hand.png" width="69" height="58" alt=""></td>                 
					  </tr> 
	...
	<tr>
		<td style="padding:20px 0;"><table width="300" align="center" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="contenttable">
			<tbody>
			  <tr>
				<td height="40" valign="middle" bgcolor="#00A651" style="background:#00A651; font-family:Arial, Helvetica, sans-serif; font-size:18px; text-align:center; font-weight:bold;"><a class="btn-color" href="{{ route('post-task')}}" style="color:#ffffff; text-decoration:none; display:block; width:100%; line-height:40px;">Post a New Task</a></td>                  
			  </tr> 
			...
			<tr>
				<td style="padding-top:20px;"><table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" align="center" class="mob-hidden">
					<tr>
						...
						<td style="padding:0 8px;"><img src="{{ url('/')}}/public/notifications/images/dot.png" height="3" width="3" alt=""></td>
						<td style="font-family: Arial, Helvetica, sans-serif; font-size: 18px;"><a href="{{ route('unsubscriber',['id'=>$data['user_id']])}}" style="color: #F7941D; text-decoration: none;;"><span style="color:#f7941d; text-decoration:none;">Unsubscribe</span></a></td>										
					</tr>																
					...
					<tr>
						<td style="font-family: Arial, Helvetica, sans-serif; font-size: 18px; padding:8px;"><a href="{{ route('unsubscriber',['id'=>$data['user_id']])}}" style="color: #F7941D; text-decoration: none;;">Unsubscribe</a></td>	
					</tr>																
				</table></td>					
			</tr>													
		</table></td>
