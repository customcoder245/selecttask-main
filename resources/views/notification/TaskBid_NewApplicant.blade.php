  ...
  <tbody>	
	...
	<tr>
		<td style="background-color: #FEF8F4;" bgcolor="#FEF8F4"><table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" align="center">
			<tr>
				<td style="font-family: Arial, Helvetica, sans-serif; font-size: 24px; font-weight: bold; line-height: 30px; color: #000000; padding:8px 15px;">Assign a pro to your open Task</td>	
				<td width="50" style="text-align: center;"><img src="{{ url('/')}}/public/notifications/images/user-tick.png" width="35" height="35" alt=""></td>			
			</tr>
	...
	<tr>
		<td bgcolor="#ffffff" style="background: #ffffff; padding:20px 15px;"><table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" align="center">
			...
			<tr>
				<td style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; color: #383838; line-height: 24px; padding-bottom:25px">A new service provider has applied for a Task you posted. Please check your account, view all applicants and 
					assign your preferred service provider. </td>
			</tr>			
			<tr>
				<td style="padding-bottom: 25px;"><table width="170" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
					<tbody>
					  <tr>
						<td height="40" valign="middle" bgcolor="#00A651" style="background:#00A651; font-family:Arial, Helvetica, sans-serif; font-size:18px; text-align:center; font-weight:bold;"><a class="btn-color" href="{{ route('status-open',['id'=>$data['task_id']])}}" style="color:#ffffff; text-decoration:none; display:block; width:100%; line-height:40px;">View Task Details</a></td>                  
					  </tr> 
			...
			<tr>
				<td style="border-top:1px #E6E6E6 solid; padding-top: 25px;"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
					<tbody>
						<tr>
							<td width="60"><img src="{{ get_profile_image_src($data['user_id'])}}" width="50" height="50" alt=""></td>
							<td><table class="contenttable" width="290" border="0" cellspacing="0" cellpadding="0" align="left" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
								<tbody>
								  <tr>
									...
									<td style="font-family:Arial, Helvetica, sans-serif; font-size:16px; font-weight:bold; padding-bottom: 5px; color: #000000;">{{ $user_data->name }}</td>                  
								  </tr> 
								  <tr>
								  <?php 
								  $rating_avg=0;
								  
								  $rating_avg=get_average_review_by_user($data['user_id']);
								  ?>
									  <td style="font-family:Arial, Helvetica, sans-serif; font-size:16px; color: #838383;"><img src="{{ url('/')}}/public/star/{{ $rating_avg }}.png" height="13" width="80" alt="" style="vertical-align: middle;">({{ get_total_review_by_user($data['user_id'])}} Reviews)</td>
								  </tr>
								...
								<tbody>
								  <tr>
									<td style="padding-right: 10px;"><table width="80" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
										<tbody>
										  <tr>
											<td height="23" valign="middle" bgcolor="#ffffff" style="background:#ffffff; font-family:Arial, Helvetica, sans-serif; font-size:12px; text-align:center; font-weight:bold; border: 1px #F7941D solid;"><a class="btn-color" href="{{ route('profile-preview',['id'=>$data['user_id']])}}" style="color:#F7941D; text-decoration:none; display:block; width:100%; line-height:19px;">View Profile</a></td>                  
										  </tr> 
									  ...
									  <td style="padding-right: 10px;"><table width="80" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
										<tbody>
										  <tr>
											<td height="25" valign="middle" bgcolor="#F7941D" style="background:#F7941D; font-family:Arial, Helvetica, sans-serif; font-size:12px; text-align:center; font-weight:bold;"><a class="btn-color" href="#" style="color:#ffffff; text-decoration:none; display:block; width:100%; line-height:21px;">Contact Pro</a></td>                  
										  </tr> 
		...
		<td bgcolor="#ffffff" class="footer" style="padding: 20px; background-color: #ffffff;"><table width="650" border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" align="center" class="contenttable">
			...
			<tr>
				<td style="padding-top:20px;"><table border="0" cellpadding="0" cellspacing="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" align="center" class="mob-hidden">
					...
					<tr>
						<td style="font-family: Arial, Helvetica, sans-serif; font-size: 18px; padding:8px;"><a href="#" style="color: #F7941D; text-decoration: none;;">Resources</a></td>
					</tr>
					<tr>
