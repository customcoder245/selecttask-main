...
<body>
    <div class="wrapper">
        ...
        <figure class="banner banner-inner banner-carpenter">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-12">
                        <div class="bannerContent">
                            <span class="jobDetailsTitle">Job Details</span>
                            <h2>Carpenter Jobs <span class="mobBlock">in New York City</span></h2>
                   ...
                   <div class="jobDetailsLeft">
                       ...
                       <div class="detailsRow">
                            ...
                            <div class="detailsRowContent">
                                <p>A carpentry contractor typically charges around <strong>$40-$90</strong> per hour for window and door installation. Carpenters in New York City typically charge <strong>$180-$380</strong> per linear foot for stock cabinets, not including the installation.</p>
                            </div>                        
                        </div><!--//Salary-->
                        ...
                        <div class="detailsRow">
                            ...
                            <div class="detailsRowContent">
                                ...
                                <ul class="bulletedlist">
                                    <li>Experience ranging from installing energy-efficient windows and slab or prehung doors, to hardwood, plywood, or fiberwood kitchen cabinets, and more</li>
                            ...
                            <div class="detailsRowContent">
                                ...
                                <ul class="bulletedlist">
                                    <li>Projects may include installing windows and doors to garage doors and stock or custom cabinets</li>
                                </ul>
                            </div>   
                            <div class="detailsRowContent">
                                <h4>Benefits:</h4>
                        ...
                        <div class="services-widget" id="sidescroller">
                            <div class="borderedframe">
                                ...
                                <div class="serviceText">
                                    <h5>Carpenter Jobs</h5>
                                    <a href="{{ route('sign-up')}}?cat=8" class="btn btn-green btn-green-shadow w-100 applyNow">Apply Now</a>
                                </div>
                            </div>
                        </div>
                   </div><!--//Right-->
