(function ($) {
    $.fn.imageUploader = function (options) {
        let defaults = { preloaded: [], imagesInputName: "images", preloadedInputName: "preloaded", label: "Drag & Drop Images" };
        let plugin = this;
        plugin.settings = {};
        ...
        let createContainer = function () {
            let $container = $("<div>", { class: "image-uploader" }),
                ...
                $i = $("<a>", { class: "btn btn-primary mt-2", text: "Browse" }).appendTo($textContainer),
