...
<body>
    <div class="wrapper">
        <header class="site-header">
            <nav class="navbar justify-content-center">
                <div class="container-fluid">
                    <a class="navbar-brand" href="landing.html"><img src="{{ url('/')}}/public/comingsoon/images/logo.svg" alt="" class="img-fluid"></a>
        ...
        <figure class="banner banner-inner banner-handyman">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-12">
                        <div class="bannerContent">
                            <span class="jobDetailsTitle">Job Details</span>
                            <h2>Handyman Jobs <span class="mobBlock">in New York City</span></h2>
                   ...
                   <div class="jobDetailsLeft">
                       ...
                       <div class="detailsRow">
                            ...
                            <div class="detailsRowContent">
                                <p>The average hourly rate for a handyman/woman in New York City is <strong>$60-$125,</strong> but this depends on the task requested.</p>
                            </div>                        
                        </div><!--//Salary-->
                        ...
                        <div class="detailsRow">
                            ...
                            <div class="detailsRowContent">
                                ...
                                <ul class="bulletedlist">
                                    <li>Skilled “jack of all trades” professional with experience ranging from installing new lighting to repairing holes in drywall to fixing kitchen appliances, and more</li>
                                    <li>Relevant certifications and previous job experience</li>
                                    <li>Ability to handle several small odd-job tasks per client</li>
                                </ul>
                            </div> 
                            <div class="detailsRowContent">
                                <h4>Job Requirements:</h4>
                                <ul class="bulletedlist">
                                    <li>Projects may include general home, office, or exterior maintenance and repairs</li>
                                </ul>
                            </div>   
                            <div class="detailsRowContent">
                                <h4>Benefits:</h4>
                        ...
                        <div class="services-widget" id="sidescroller">
                            <div class="borderedframe">
                                ...
                                <div class="serviceText">
                                    <h5>Handyman Jobs</h5>
                                    <a href="{{ route('sign-up')}}?cat=2" class="btn btn-green btn-green-shadow w-100 applyNow">Apply Now</a>
                                </div>
                            </div>
                        </div>
                   </div><!--//Right-->
