...
<body>
    <div class="wrapper">
        ...
        <figure class="banner banner-inner banner-electric">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-12">
                        <div class="bannerContent">
                            <span class="jobDetailsTitle">Job Details</span>
                            <h2>Electrician Jobs <span class="mobBlock">in New York City</span></h2>
                   ...
                   <div class="jobDetailsLeft">
                       ...
                       <div class="detailsRow">
                            ...
                            <div class="detailsRowContent">
                                <p>The average hourly rate for an electrician in New York City is <strong>$50-110,</strong> but this depends on the task requested.</p>
                            </div>                        
                        </div><!--//Salary-->
                        ...
                        <div class="detailsRow">
                            ...
                            <div class="detailsRowContent">
                                ...
                                <ul class="bulletedlist">
                                    <li>Experience ranging from appliance and fixture installations, to home lighting and outlet repairs, and more</li>
                                    <li>Relevant certifications and previous job experience</li>
                                    <li>Meets requirements established by the New York City local government, passing grade for licensure exam</li>
                                </ul>
                            </div> 
                            <div class="detailsRowContent">
                                <h4>Job Requirements:</h4>
                                <ul class="bulletedlist">
                                    <li>Projects may include minor fixes like circuit panel and outlet repairs, to major fixes like rewiring buildings and weatherhead repairs</li>
                                </ul>
                            </div>   
                            <div class="detailsRowContent">
                                <h4>Benefits:</h4>
                        ...
                        <div class="services-widget" id="sidescroller">
                            <div class="borderedframe">
                                ...
                                <div class="serviceText">
                                    <h5>Electrician Jobs</h5>
                                    <a href="{{ route('sign-up')}}?cat=7" class="btn btn-green btn-green-shadow w-100 applyNow">Apply Now</a>
                                </div>
                            </div>
                        </div>
                   </div><!--//Right-->
