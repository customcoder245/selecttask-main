...
<body>
    <div class="wrapper">
        ...
        <figure class="banner banner-inner banner-roofing">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-12">
                        <div class="bannerContent">
                            <span class="jobDetailsTitle">Job Details</span>
                            <h2>Roofing Jobs <span class="mobBlock">in New York City</span></h2>
                   ...
                   <div class="jobDetailsLeft">
                       ...
                       <div class="detailsRow">
                            ...
                            <div class="detailsRowContent">
                                <p>On average, roofers in New York City charge about <strong>$350-$550 per square ($3.50-$5.50 per sqft)</strong> for roof repairs and <strong>$550-$940 per square ($5.50-$9.40 per sqft)</strong> for roof replacement.</p>
                            </div>                        
                        </div><!--//Salary-->
                        ...
                        <div class="detailsRow">
                            ...
                            <div class="detailsRowContent">
                                ...
                                <ul class="bulletedlist">
                                    <li>Experience ranging from roof installation, replacements, inspections, and maintenance</li>
                                    <li>Relevant certifications and previous job experience</li>
                                    <li>Trained and certified by OSHA</li>
                                </ul>
                            </div> 
                            <div class="detailsRowContent">
                                <h4>Job Requirements:</h4>
                                <ul class="bulletedlist">
                                    <li>Projects may include roof inspections, or repairing or replacing asphalt shingle, rubber, copper, tile, or metal roofs</li>
                                </ul>
                            </div>   
                            <div class="detailsRowContent">
                                <h4>Benefits:</h4>
                        ...
                        <div class="services-widget" id="sidescroller">
                            <div class="borderedframe">
                                ...
                                <div class="serviceText">
                                    <h5>Roofing Jobs</h5>
                                    <a href="{{ route('sign-up')}}?cat=6" class="btn btn-green btn-green-shadow w-100 applyNow">Apply Now</a>
                                </div>
                            </div>
                        </div>
                   </div><!--//Right-->
