  ...
  <tbody>	
	...
	<tr>
		<td style="background-color: #FEF8F4;" bgcolor="#FEF8F4"><table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" align="center">
			<tr>
				<td style="font-family: Arial, Helvetica, sans-serif; font-size: 24px; font-weight: bold; line-height: 30px; color: #000000; padding:8px 15px;">Congrats on taking the first step to becoming a Select Task pro!</td>	
	...
	<tr>
		<td bgcolor="#ffffff" style="background: #ffffff; padding:20px 15px;"><table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" align="center">
			...
			<tr>
				<td style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; color: #383838; line-height: 24px; padding-bottom:25px">Thanks for your interest in becoming a pro with Select Task! We’re excited to have you on board. We’re still preparing for launch and are aiming to be live after the summer.</td>
			</tr>
			<tr>
				<td style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; color: #383838; line-height: 24px; padding-bottom:25px">We’ll keep you posted on any updates and are excited to welcome you to the team in the coming months.</td>
			</tr>
			<tr>
				<td style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; color: #383838; line-height: 24px; padding-bottom:25px">As always, let us know if you have any questions.</td>
			</tr>
			<tr>
				<td style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; color: #383838; line-height: 24px;">Regards,<br />The Select Task Team</td>
			</tr>
