                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="titleRow flex-wrap d-flex justify-content-between align-items-center">
                            ...
                            <a href="javascript:void(0)" class="btn btn-green d-inline-block d-md-none"   data-toggle="modal" data-target="#addReviewModal">Add review</a>
                                ...
                                <div class="JobDetailsTopRow d-flex justify-content-between">
                                    <div class="jobLeft">
                                        ...
                                        <div class="d-block d-md-none">
                                            <label>Status</label>
                                            <p><a href="#" class="text-secondary semiBold">Completed</a>
                                                <span class="infoIcon centereditem"><img src="{{ url('/public/user')}}/assets/images/i.svg" alt="">
                    ...
                    <div class="col-md-7">
                        <div class="topButtons text-right text-lato f-16 mb-2">
                            <a href="javascript:void(0)" class="btn btn-green d-md-inline-block d-none"   data-toggle="modal" data-target="#addReviewModal">Add review</a>
                                ...
                                <div class="applicantList-row d-flex">
                                    ...
                                    <div class="applicantDetails flex-grow-1">
                                        <div class="d-flex justify-content-between">
                                            <h4>Srajan Gupta</h4>
                                            <a href="#" class="underlinelink text-primary f-12">View Profile</a>
                                        </div>
