  ...
  <tbody>	
	...
	<tr>
		<td style="background-color: #FEF8F4;" bgcolor="#FEF8F4"><table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" align="center">
			<tr>
				<td style="font-family: Arial, Helvetica, sans-serif; font-size: 24px; font-weight: bold; line-height: 30px; color: #000000; padding:8px 15px;">{{ $data['name'] }}, welcome to the Select Task family!</td>	
				<td width="52" style="text-align: center; padding-right: 12px;"><img src="{{ url('/')}}/public/notifications/images/welcome.png" width="54" height="35" alt=""></td>			
			</tr>
	...
	<tr>
		<td bgcolor="#ffffff" style="background: #ffffff; padding:20px 15px;"><table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" align="center">
			...
			<tr>
				<td style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; color: #383838; line-height: 24px; padding-bottom:25px">You are successfully registered with Select Task as a customer. Now you can easily get help with your repair and maintenance Tasks. To get started, post a task in your area.</td>
			</tr>
			<tr>
				<td style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; color: #383838; line-height: 24px; padding-bottom:25px">Thanks for being part of the Select Task family!</td>
			</tr>
			<tr>
				<td style="padding-bottom: 20px;"><table width="170" border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;">
					<tbody>
					  <tr>
						<td height="40" valign="middle" bgcolor="#F7941D" style="background:#F7941D; font-family:Arial, Helvetica, sans-serif; font-size:18px; text-align:center; font-weight:bold;"><a class="btn-color" href="{{ route('task-list')}}" style="color:#ffffff; text-decoration:none; display:block; width:100%; line-height:40px;">View Dashboard</a></td>                  
					  </tr> 
