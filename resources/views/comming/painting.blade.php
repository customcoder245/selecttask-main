...
<body>
    <div class="wrapper">
        ...
        <figure class="banner banner-inner banner-painting">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-12">
                        <div class="bannerContent">
                            <span class="jobDetailsTitle">Job Details</span>
                            <h2>Painting Jobs <span class="mobBlock">in New York City</span></h2>
                   ...
                   <div class="jobDetailsLeft">
                       ...
                       <div class="detailsRow">
                            ...
                            <div class="detailsRowContent">
                                <p>Painters usually charge per square foot. You can expect to be paid about <strong>$5.81 per sq ft.</strong> This usually equates to an hourly rate of <strong>$50-$100,</strong> but this depends on the task and how quickly you finish the job.</p>
                            </div>                        
                        </div><!--//Salary-->
                        ...
                        <div class="detailsRow">
                            ...
                            <div class="detailsRowContent">
                                ...
                                <ul class="bulletedlist">
                                    <li>Experience ranging from painting kitchens, doors, ceilings, and bathrooms, to significant or historical building exteriors, to painting brick and stone, and more</li>
                            ...
                            <div class="detailsRowContent">
                                ...
                                <ul class="bulletedlist">
                                    <li>Projects may include interior or exterior painting, commercial or speciality projects, wallpaper removal, and power washing</li>
                                </ul>
                            </div>   
                            <div class="detailsRowContent">
                                <h4>Benefits:</h4>
                        ...
                        <div class="services-widget" id="sidescroller">
                            <div class="borderedframe">
                                ...
                                <div class="serviceText">
                                    <h5>Painting Jobs</h5>
                                    <a href="{{ route('sign-up')}}?cat=4" class="btn btn-green btn-green-shadow w-100 applyNow">Apply Now</a>
                                </div>
                            </div>
                        </div>
                   </div><!--//Right-->
