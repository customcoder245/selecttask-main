  ...
  <tbody>	
	...
	<tr>
		<td bgcolor="#ffffff" style="background: #ffffff; padding:20px 15px;"><table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" align="center">
			<tr>
			 <th style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; font-weight: bold; color: #00A651; line-height: 24px; padding-bottom:25px">First Name</th>
				<td style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; font-weight: bold; color: #00A651; line-height: 24px; padding-bottom:25px"> {{ $data['first_name'] }}</td>				
			</tr>
			
			<tr>
			 <th style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; font-weight: bold; color: #00A651; line-height: 24px; padding-bottom:25px">Last Name</th>
				<td style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; font-weight: bold; color: #00A651; line-height: 24px; padding-bottom:25px"> {{ $data['last_name'] }}</td>				
			</tr>
			
			<tr>
			 <th style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; font-weight: bold; color: #00A651; line-height: 24px; padding-bottom:25px">E-mail</th>
				<td style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; font-weight: bold; color: #00A651; line-height: 24px; padding-bottom:25px"> {{ $data['email'] }}</td>				
			</tr>
			
			<tr>
			 <th style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; font-weight: bold; color: #00A651; line-height: 24px; padding-bottom:25px">Phone</th>
				<td style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; font-weight: bold; color: #00A651; line-height: 24px; padding-bottom:25px"> {{ $data['phone'] }}</td>				
			</tr>
			
			<tr>
				<td style="font-family: Arial, Helvetica, sans-serif; font-size: 16px; color: #383838; line-height: 24px; padding-bottom:25px">
				{{ $data['problem']}}
				</td>
			</tr>
