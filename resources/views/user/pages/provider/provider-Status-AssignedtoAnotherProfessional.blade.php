                ...
                <div class="row">
                    <div class="col-md-5">
                        <div class="titleRow flex-wrap d-flex justify-content-between align-items-center">
                            ...
                            <a href="{{ route('view-invoice')}}" class="textgreen underlinelink Bold d-inline-block d-md-none ml-auto text-lato mr-3">View Invoice</a>                           
                                ...
                                <div class="JobDetailsTopRow d-flex justify-content-between">
                                    <div class="jobLeft">
                                        ...
                                        <div class="d-block d-md-none">
                                            <label>Status</label>
                                            <p><a href="#" class="text-secondary semiBold">Assigned to another professional</a>
                                                <span class="infoIcon centereditem"><img src="{{ url('/public/user/')}}/assets/images/i.svg" alt="">
                    ...
                    <div class="col-md-7">
                        <div class="topButtons text-right text-lato f-16 mb-2">
                            <a href="{{ route('view-invoice')}}" class="textgreen underlinelink Bold  d-md-inline-block d-none">View Invoice</a>
